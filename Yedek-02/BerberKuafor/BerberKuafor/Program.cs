...
builder.Services.AddDefaultIdentity<BerberKuafor.Areas.Identity.Data.BerberKuaforUser>(options => options.SignIn.RequireConfirmedAccount = true).AddEntityFrameworkStores<BerberKuaforDBContext>();
